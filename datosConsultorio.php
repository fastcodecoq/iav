...
<div class="divCampo">
	...
	<div class="divCampo">
     ...
     <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><select name="tipoConsultorio" id="tipoConsultorio" class="validate[required] text-input"></span>
		<?php
        for ($i=0; $i <= 5; $i++)
        {
        ?>
          <option value="<?php if($i != 0) { echo $i;}?>"><?php echo tipo_consultorio($i)?></option>
        <?php
        }
        ?>
        </select></span>
