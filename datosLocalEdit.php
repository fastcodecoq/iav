...
<div style="float:left; width:500px; margin-top:20px;margin-left: 100px; font-size: 12px;">
   ...
   <div class="divCampo">
    ...
    <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><input type="text" name="vlrventa" id="vlrventa" class="validate[required] text-input" value="<?php echo $registro_con['campo_5']?>" <?php /*?>onkeyup="puntillos(this)" onchange="puntillos(this)"<?php */?> /></span>    
    </div>
	<?php
	}
	?>
    ...
    <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><input type="text" name="canon" id="canon" class="validate[required] text-input" value="<?php echo $registro_con['campo_53']?>"<?php /*?>onkeyup="puntillos(this)" onchange="puntillos(this)"<?php */?> /></span>
    </div>  
    <?php
	}
	?> 
  ...
  <div class="divCampo">
    ...
    <div class="divCampo">
        ...
        {
        ?>
          <option value="<?php echo $i?>" <?php if($registro_con['campo_31'] == $i){ echo 'selected';}?>><?php echo tipo_local($i)?></option>
        <?php
        }
        ?>
        </select></span>
