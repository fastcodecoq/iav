...
//echo "sf".$anexo =$_GET["para"]."/".$_GET["tipoInmueble"]."/".$_GET["area"]."/".$_GET["ciudad"]."/".$_GET["precio"]."/".$_GET["codigo"]."/".$orden;
	...
	$consulta = "SELECT usuarios.banner1,usuarios.banner2, usuarios.nombreEmpresa,usuarios.identificacion,usuarios.telefono, celular,
	usuarios.url,usuarios.email, usuarios.rol, identificacion, nombreMunicipio ,url
	FROM  usuarios , municipio
WHERE  usuarios.identificacion='".$inmovi."' and  idmunicipio=ciudad "; // $condCodigo $tipo_negociacion $condCiudad $condPalabraClave $condicionOrdenar";

		
			$resultadonombre = mysql_query($consulta);
            $registronom = mysql_fetch_assoc($resultadonombre);
			$foto="";
			
			$nombreEmpresa=$registronom['nombreEmpresa'];
			$nombreurl=$registronom['url'];
			$banner1=		$registronom['banner1'];
			$banner2=		$registronom['banner2'];
			$telefono=		$registronom['telefono'];
			$celContacto=		$registronom['celular'];
			$email=		$registronom['email'];
					
					
			if($registronom['url'] != ''){
					
            		$foto="http://www.inmueblealaventa.com/bannerInmobiliariaConstructora/".$registronom['banner1'];
...
<title><?php echo $nombreEmpresa?> | Inmuebles en Venta y Arriendo - Inmueblealaventa</title>
<meta property="fb:admins" content="100005082218469">
<meta property="fb:app_id" content="1435079113381937">
<meta property="og:url" content="">
<meta property="og:title" content="Inmuebles de <?php echo $nombreEmpresa?> en Venta y Arriendo - Inmueble a la venta">
<meta property="og:description" content="Finca raíz en Colombia - Inmuebles comerciales y residenciales en venta y renta en Colombia. Encuentre todo el inventario inmobiliario en Colombia y conozca los precios y fotografias de las propiedades desde la comodida de su hogar">
<meta property="og:type" content="other">
<meta property="og:image" content="<?php echo $foto?> ">
<meta name="description" content="Finca raíz en Colombia - Inmuebles comerciales y residenciales en venta y arriendo en Colombia. Encuentre todo el inventario inmobiliario en Colombia y conozca los precios y fotografias de las propiedades desde la comodida de su hogar">
<meta name="keywords" content="inmueblea la venta, inmuebles en venta, propiedades, arriendo inmuebles">
...
<section>
	<div class="contenedor">
        ...
        <h1><?php echo $registronom['nombreEmpresa']?> | Inmuebles en Venta y Arriendo</h1></div>
...
?>
			...
			$pagina = "_resultado_inmobiliaria.php"; 	//your file name  (the name of this file)
			...
			$condhabita  $condgaraje $condbano and usuarios.identificacion='".$inmovi."'   $condarea $condantiguedad $condCiudad $condprecio $tipo_negociacion  {$order} $barrio"; // $condCodigo $tipo_negociacion $condCiudad $condPalabraClave $condicionOrdenar";
			//echo $consulta;
            ...
            <div class="inmobiliaria" style="overflow:hidden">
                ...
                <div class="contenido">
                  <div class="imagen"> 
					...
					if($nombreurl != ""){
					?>
            		<img style="cursor:pointer"  src="/bannerInmobiliariaConstructora/<?php echo $banner1?>" width="177" height="177" border ="0" />
                	<?php
					}
					else
					{
					?>
                    <img  style="cursor:pointer"  src="/bannerInmobiliariaConstructora/<?php echo $banner2?>" width="177" height="177" border ="0" />
                    <?php	
					}
					?>
                 </div> 
                  <div class="direccion">
                    ...
                    <p><?php  echo $telefono?> • <?php  echo $celContacto?></p>
                    <p>&nbsp;</p>
                  ...
                  <div class="contacto">
                    ...
                    <p>&nbsp;</p>
                    <a style="margin-left:0px;" class="boton" href="mailto:<?php  echo $email?>">Contactar via E-mail</a> </div>
                </div>
              </div>  
      ...
      $order = ($order) ? $orderes[$order] : "";
			...
			and inmueble.usuario = usuarios.identificacion
			and  usuarios.rol = rol.idrol
			$tipoporye $condTipInm  $condarea  $barrio and usuarios.identificacion='".$inmovi."'  $condCiudad $condantiguedad $condhabita $condbano  $condgaraje
...
?>
       ...
       <div class="recuadro_publicidad">
             ...
             <div style="margin:0 auto; width:160px; height:611px; margin-top:3px; ">           
                        <!-- Banner -->
