...
// conf opcionales
$dirpermission = 0705;       //Crear directorio - example: 0705 would be 'drwx---r-x'.
$filepermission = 0604;      // Crear arch - example: 0604 would be '-rw----r--'.
...
function listing_page ($message = null) {
    ...
    echo '<h1 style="margin-bottom: 0"> </h1>
...
'password' => 'Clave',
'add' => 'agregar',
'add_basic_auth' => 'agregar autentificacion basica',
...
'not_readable' => '"[%1]" no pudo ser leido.'
        );
// ------------------------------------------------------ >>
...
<title>CENTRAL DE BOBINADOS</title>
