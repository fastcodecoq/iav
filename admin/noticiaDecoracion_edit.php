...
if(isset($_POST["txt_titulo"]) && $_POST["txt_titulo"] != "")
{
	...
	{
		$foto = subir_archivo($_FILES["txt_imagen"]["name"], $_FILES["txt_imagen"]["size"], 2000000, $_FILES["txt_imagen"]["tmp_name"], "../imgDecoracion/");
		$fotos .= ", imagen = '$foto'";
		
		if ($_POST["hdd_imagen"] != "")
		{
			unlink("../imgDecoracion/".$_POST["hdd_imagen"]);
		}
	}
	
		$actualizar = "UPDATE decoracion SET titulo='$titulo' $fotos, fecha='$fecha', contenido='$contenido' WHERE id = $id";
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="box">
  			...
  			<div class="right"></div>
  			<div class="heading">
				<h1>&nbsp;<strong>EDITAR NOTICIA DE DECORACI&Oacute;N</strong></h1>
				<div align="right"></div>
		  	</div>
		  </td>
        </tr>
        <tr>
          <td class="box" valign="top"><div class="content">
            ...
            <?php
            $consulta = "SELECT * FROM decoracion WHERE id = ".$id;
                ...
                <td bgcolor="#EFEFEF" style="text-align: center;"><table width="100%" class="form">
                  ...
                  <tr>
                    <td colspan="2" align="left"><span class="required">* Campos Obligatorios </span><br />
                      ...
                      &nbsp;&nbsp;
                      <input name="button" type="button" onclick="if(confirm('Desea continuar sin guardar\nSe perderan los cambios')) { document.frm_noticias.action = 'noticiasDecoracion.php'; document.frm_noticias.submit() };" value="Cancelar"/>
                      <br />
                      </td>
                  </tr>
                </table></td>
