...
if(isset($_POST["hdd_accion"]) && $_POST["hdd_accion"] == "guardar")
{
	...
	$insercion = "INSERT INTO hoteles (nombre, direccion, ciudad, precioNoche, descripcion, fechaCreacion, estado) VALUES ('$nombre', '$direccion', $ciudad, $precio,  '$descripcion', NOW(), 1)";
		...
		if (mysql_db_query($bd_nombre, $insercion))
		{
			...
			$consulta = "SELECT * FROM fotostemp WHERE cod_temp = 9999999";			
			$resultado = mysql_query($consulta, $conexion);
			while($registro = mysql_fetch_array($resultado))
			{			
				$insercion = "INSERT INTO fotos_hotel (foto, cod_hot, fecha_creacion) VALUES ('".$registro['nombre_foto']."', '".$ID."', NOW())";
				mysql_db_query($bd_nombre, $insercion);
			}
			
			//Eliminamos las fotos de este inmueble de la tabla temporal de fotos
			$eliminacion = "DELETE FROM fotostemp WHERE cod_temp = 9999999";
			mysql_db_query($bd_nombre, $eliminacion);
			
			?>
			<script language="javascript" type="text/javascript">
                alert("El hotel fue creado con exito");
		...
		?>
			<script language="javascript" type="text/javascript">
				alert("El hotel no pudo ser creado.  Intentelo mas tarde y si el problema persiste contacte a su webmaster");
				document.location.href = "hoteles.php";
			</script>
		<?
		}
              ...
              <tr>
                <td bgcolor="#EFEFEF" style="text-align: center;"><table width="100%" class="form">
                  <tr>
                    ...
                    <td align="left"><input name="nombre" type="text" id="nombre" size="80" class="validate[required]" data-errormessage-value-missing="* Campo obligatorio"/></td>
                  </tr>
                  <tr>
                    <td align="left"><span class="required">*</span>&nbsp;Direcci&oacute;n</td>
                    <td align="left"><input name="direccion" type="text" class="validate[required] text-input" id="direccion" value="" size="80"/>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="precio" type="text" class="validate[required,custom[onlyNumberSp]] text-input" id="precio" value=""/>
                    </td>
                  </tr>
				  <tr>
				    <td align="left"><span class="required">*</span>Descripci&oacute;n</td>
				    <td align="left"><textarea cols="120" id="descripcion" name="descripcion" rows="10" class="validate[required] text-input"></textarea>
...
<input name="hdd_accion" type="hidden" value="guardar" />
</form>
</body>
</html>
