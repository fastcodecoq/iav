...
if(isset($_POST["txt_titulo"]) && $_POST["txt_titulo"] != "")
{
	...
	if ($_FILES["txt_imagen"]["name"] != "")
	{
		...
		if ($_POST["hdd_imagen"] != "")
		{
			unlink("../imgGuiaTurismo/".$_POST["hdd_imagen"]);
		}
	}
	
		$actualizar = "UPDATE guiaturismo SET titulo='$titulo' $fotos, fecha='$fecha', contenido='$contenido' WHERE id = $id";
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="box" valign="top"><div class="content">
            ...
            <?php
            $consulta = "SELECT * FROM guiaturismo WHERE id = ".$id;
