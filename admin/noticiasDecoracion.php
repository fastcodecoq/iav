...
$eliminados = $no_eliminados = 0;
	...
	{
		$consulta = "SELECT * FROM decoracion WHERE id = ".$_POST["chk_usuarios"][$i];;
		$resultado_del = mysql_query($consulta, $conexion);	
		$imagenes = mysql_fetch_array($resultado_del);
		
		if($imagenes["imagen"] != "")
		{
			unlink("../imgDecoracion/".$imagenes["imagen"]);	
		}
			
		$eliminacion = "DELETE FROM decoracion WHERE id = ".$_POST["chk_usuarios"][$i];
	...
	document.location.href = "noticiasDecoracion.php";
	</script>
	<?
}
?>
...
<?php					
	$pagina = "noticiasDecoracion.php"; 	//your file name  (the name of this file)
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="box">
  			...
  			<div class="right"></div>
  			<div class="heading">
				<h1>&nbsp;<strong>NOTICIAS DE DECORACI&Oacute;N</strong></h1>
				<div align="right"></div>
		  	</div>		  </td>
        </tr>
        <tr>
          <td class="box" valign="top"><div class="content">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td align="right">
				<input type="submit" name="Submit" value="Agregar" onclick="document.frm_noticias.action = 'noticiaDecoracion_add.php'; document.frm_noticias.submit()" />
				&nbsp;&nbsp;
            ...
            <?php
			$consulta = "SELECT * FROM decoracion ORDER BY fecha DESC";
			$resultado = mysql_query($consulta, $conexion);
			$num_registros = mysql_num_rows($resultado);
			$total_paginas = ceil($num_registros / $TAMANO_PAGINA); 
			$registro = mysql_fetch_array($resultado);
			
			$consulta = "SELECT * FROM decoracion ORDER BY fecha DESC LIMIT $inicio , $TAMANO_PAGINA  ";
			$resultado = mysql_query($consulta, $conexion);
			...
			?>
              ...
              <tr >
                ...
                <td align="center"><a href="#" onclick="editar_noticiaDecoracion(<?php echo $registro["id"]?>);">[Editar]</a></td>
              </tr>
              <?
				 }
				 ?>
			...
			{
				echo "No existen noticias de decoraci&oacute;n creadas";
			}
			?>
            </table>
          </div></td>
