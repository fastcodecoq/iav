...
if(isset($_POST["txt_nombre"]) && $_POST["txt_nombre"] != "")
{
	...
	$recomendados =  '';
	for ($i = 0; $i < sizeof($_POST["prod_sugeridos"]); $i++)
	{
		$recomendados .= $_POST["prod_sugeridos"][$i].';';
	}
	...
	if($_POST["txt_precio_des"] != '')
	{
		$precio_des = $_POST["txt_precio_des"] ;
	}
	else
	{
		$precio_des = 0;
	...
	$descripcion1 = $_POST["elm1"];
	$descripcion2 = $_POST["elm2"];
	$descripcion3 = $_POST["elm3"];
	$descripcion4 = $_POST["elm4"];
	$descripcion5 = $_POST["elm5"];
	$url = $_POST["url"];
	$h1 = $_POST["h1"];
	$h2 = $_POST["h2"];
	$h3 = $_POST["h3"];
	...
	{
		$imagen = subir_archivo($_FILES["txt_imagen"]["name"], $_FILES["txt_imagen"]["size"], 2000000, $_FILES["txt_imagen"]["tmp_name"], "../imagen_productos/");
	}
	
	$insercion = "INSERT INTO producto (idproducto, categoria_idcategoria, desproducto, valproducto, valproducto_anti, rutproducto, promocion, descripcion1 , descripcion2, descripcion3, descripcion4, descripcion5, agotado, actproducto, recomendados, url, h1,h2,h3,h4,h5,h6, title, description,keywords) VALUES (NULL, $categoria, '$nombre', $precio1, $precio2, '$imagen', $promocion , '$descripcion1', '$descripcion2', '$descripcion3', '$descripcion4', '$descripcion5', $agotado, 'S', '$recomendados', '$url', '$h1','$h2','$h3','$h4','$h5','$h6','$title','$description','$keywords')";
		
		if (mysql_db_query($bd_nombre, $insercion))
		{
			//ACTUALIZO LA BITACORA
			$des_bitacora = 'Agrego producto '.$nombre;
        ...
        <tr>
          <td class="box" valign="top"><div class="content">
            ...
            <ul class="tabs">
                ...
                <li><a href="#tab2">Descripci&oacute;n</a></li>
                <li><a href="#tab3">Detalles</a></li>
                <li><a href="#tab4">Beneficios claves</a></li>
                <li><a href="#tab5">Uso</a></li>
                <li><a href="#tab6">Presentaci&oacute;n</a></li>
                ...
                <td bgcolor="#EFEFEF" style="text-align: left;">
                  ...
                  <tr>
					...
					<select name="cmb_categoria" id="cmb_categoria">
                        ...
                        <?
						$consulta = "SELECT idsubcategoria, dessubcategoria FROM subcategorias ORDER BY dessubcategoria ASC";
						...
						{
						?>
                        <option value="<?=$registro_cat["idsubcategoria"]?>">
                          <?=$registro_cat["dessubcategoria"]?>
                          </option>
                        <?
						}
						?>
                  ...
                  <tr>
                    ...
                    <td align="left"><label>
                      <input name="txt_precio" type="text" id="txt_precio" onkeypress="return soloNumeros(event);" size="50" />
                      </label></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
				    <td align="left">Promoci&oacute;n </td>
				    <td align="left">
				      <input name="chk_promocion" type="checkbox" id="chk_promocion" value="1" /></td>
				    </tr>
                  <tr>
				    <td align="left">Precio Promoci&oacute;n</td>
				    <td align="left"><input type="text" name="txt_precio_des" id="txt_precio_des" value="" onkeypress="return soloNumeros(event);" /></td>
				  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="left">Productos a recomendar</td>
                    <td align="left">
                    <table width="250">
                    <tr>
                        <td>
                            <select id="productos" size="6">
                                <?
                                $consulta = "SELECT idproducto, desproducto FROM producto ORDER BY desproducto ASC";
                                $resultado_cat = mysql_query($consulta, $conexion);
                                
                                while ($registro_cat= mysql_fetch_array($resultado_cat))
                                {
                                ?>
                                <option value="<?php echo $registro_cat["idproducto"]?>"><?=$registro_cat["desproducto"]?></option>
                                <?
                                }
                                ?>		
                            </select>
                        </td><td>
                            <input type="button" onClick="adicionar();" value =">>"/><br/>
                            <input type="button" onClick="remover();" value ="<<"/>
                        </td><td>
                            <select multiple="multiple"  id="prod_sugeridos" size=6 name="prod_sugeridos[]">
                            </select>
                        </td>
                    </tr>
                    </table>
            ...
            <textarea id="elm1" name="elm1" rows="15" cols="80" style="width: 80%" class="mceEditor"></textarea>
            </div>
            <div id="tab3" class="tab_content">
            <textarea id="elm2" name="elm2" rows="15" cols="80" style="width: 80%" class="mceEditor"></textarea>
            </div>
            <div id="tab4" class="tab_content">
            <textarea id="elm3" name="elm3" rows="15" cols="80" style="width: 80%" class="mceEditor"></textarea>
            </div>
            <div id="tab5" class="tab_content">
            <textarea id="elm4" name="elm4" rows="15" cols="80" style="width: 80%" class="mceEditor"></textarea>
            </div>
            <div id="tab6" class="tab_content">
            <textarea id="elm5" name="elm5" rows="15" cols="80" style="width: 80%" class="mceEditor"></textarea>
            </div>
