...
<?php					
	$pagina = "noticias.php"; 	//your file name  (the name of this file)
        ...
        <tr>
          <td class="box" valign="top"><div class="content">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td align="right">
				<input type="submit" name="Submit" value="Agregar" onclick="document.frm_noticias.action = 'noticia_add.php'; document.frm_noticias.submit()" />
				&nbsp;&nbsp;
			...
			$consulta = "SELECT * FROM noticias ORDER BY fecha DESC LIMIT $inicio , $TAMANO_PAGINA  ";
			$resultado = mysql_query($consulta, $conexion);
			...
			?>
              ...
              <tr >
                ...
                <td align="center"><a href="#" onclick="editar_noticia(<?php echo $registro["id"]?>);">[Editar]</a></td>
              </tr>
              <?
				 }
				 ?>
