...
if(isset($_POST["txt_titulo"]) && $_POST["txt_titulo"] != "")
{
	...
	$insercion = "INSERT INTO decoracion (titulo, fecha, imagen, contenido) VALUES ('$titulo', '$fecha', '$foto',  '$contenido')";
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="box">
  			...
  			<div class="right"></div>
  			<div class="heading">
				<h1>&nbsp;<strong>AGREGAR NOTICIA DE DECORACI&Oacute;N</strong></h1>
				<div align="right"></div>
		  	</div>
		  </td>
        </tr>
