...
<div style="float:left; width:500px; margin-top:20px;margin-left: 100px; font-size: 12px;">
    ...
    <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><input type="text" name="numApartamento" id="numApartamento" class="text-input" value="<?php echo $registro_con['campo_35']?>"/></span>
    </div>
    <div class="divCampo">
    ...
    <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados">  <input type="text" name="vlrAdmon" id="vlrAdmon" class="text-input"  value="<?php echo $registro_con['campo_19']?>" <?php /*?>onkeyup="puntillos(this)" onchange="puntillos(this)"<?php */?>/>
        </span>
    </div>
	...
	<div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><select name="numGarajes" id="numGarajes" class="validate[required] text-input">
          ...
          <option value="+3" <?php if($registr_con['campo_25'] == '+3'){ echo 'selected';}?>>+3</option>
        </select></span>
	</div>
    <div class="divCampo">
