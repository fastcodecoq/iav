...
<table width="100%" border="0" class="recuadroazul">
  <tr>
    ...
    <div class="divCampo">
        ...
        <select name="tipoConsultorio"  disabled="disabled" id="tipoConsultorio" class="validate[required] text-input">
		<?php
        for ($i=0; $i <= 5; $i++)
        {
        ?>
          <option value="<?php echo $i?>" <?php if($registro['campo_18'] == $i){ echo 'selected';}?>><?php echo tipo_consultorio($i)?></option>
        <?php
        }
        ?>
        </select>
...
<div style="float:left; width:325px; padding-top:20px">
    ...
    <div class="divCampo">
      ...
      <select name="numBanos" disabled="disabled"  id="numBanos" class="validate[required] text-input">
  	...
  	<div class="divCampo">
        <label for="tipoPiso"><strong>Tipo de pisos:</strong></label>
      	<select name="tipoPiso"  disabled="disabled" id="tipoPiso" class="validate[required]">
		  <?php
            for ($i=0; $i <= 8; $i++)
            {
            ?>
  	...
  	<div class="divCampo">
    	...
    	<select name="parqVisitantes" disabled="disabled"  id="parqVisitantes" class="validate[required] text-input">
        	<option value="">- Escoja -</option>
        	...
        	<option value="4" <?php if($registro['campo_20'] == 4){ echo 'selected';}?> <?php if($registro['campo_20'] == '+5'){ echo 'selected';}?>>4</option>
