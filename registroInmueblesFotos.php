...
if($_POST['plan'] == 1)
 ...
 $codigoTemp=$_POST['cod_temp'];
 if (isset($_POST['hdd_plan'])){	$_POST['hdd_plan']=$_POST['hdd_plan'];}else{	$_POST['hdd_plan']="";}
...
<script type="text/javascript">
		...
		new AjaxUpload(button,{
			action: 'subir_imagenes_ajax/subenueva.php?codTemp='+<?php echo $codigoTemp?>, 
			name: 'image[]',
		...
		$("#gallery").load("subir_imagenes_ajax/subenueva.php?action=listFotos&codTemp=<?php echo $codigoTemp?>");
		
		// Eliminar
		
		$("#gallery li a").live("click",function(){
			var a = $(this)
			$.get("subir_imagenes_ajax/procesa.php?subenueva=eliminar",{id:a.attr("id")},function(){
...
<section>
  <div style="clear:left; padding-top:10px;" class="contenedor">
        ...
        <div class="recuadroAzul">
        	<h1 style="color:#808080" align="center">PUBLICACI&Oacute;N DE FOTOS Y VIDEO</h1>
            <div style="color:#346599; padding:0 15px;">Por favor revise que sus fotograf&iacute;as pesen como m&aacute;ximo 600Kb y no contengan caractes especiales (&ntilde;, espacios ni tildes). Se aceptan solo im&aacute;genes con formato (JPG, JPGE Y PNG)</div>
            ...
            <div style="width:960px; float:left;">
                ...
                <div align="center"><input type="submit" value="Guardar" class="boton medium naranja"/>&nbsp;&nbsp;<input type="button" name="cancelar" class="boton medium red" onClick="if(confirm('Desea continuar sin guardar\nSe perderan los cambios')) { document.registro.action = 'cuenta.php'; document.registro.submit() };" value="Cancelar" /></div>
            </div>
