...
<div class="divCampo">
    ...
    <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><select name="interior" id="interior" class="text-input"></span>
          <option value="">- Escoja -</option>
          <option value="1">Si</option>
          <option value="2">No</option>
        </select>
   	  <label>Cual?</label>
        <input name="cual" type="text" id="cual" size="5">
    </div>
    <div class="divCampo">
        <label for="numApartamento"><strong>Numero de apartamento:</strong></label>
        <span class="mostrarDatosInmueblesResultados"><input type="text" name="numApartamento" id="numApartamento" class="text-input" /></span>
    </div>
    <div class="divCampo">
    ...
    <div class="divCampo">
        <label><strong>Numero de piso:</strong></label>
         <span class="mostrarDatosInmueblesResultados"><input type="text" name="numPiso" id="numPiso" class="text-input" /></span>
    </div>
    <div class="divCampo">
