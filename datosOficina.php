...
<div class="divCampo">
    ...
    <div class="divCampo">
        ...
        {
        ?>
          <option value="<?php if($i != 0) { echo $i;}?>"><?php echo tipo_oficina($i)?></option>
        <?php
        }
        ?>
        </select></span>
    ...
    <!--<div class="divCampo">
      <label for="vlrAdmon"><strong>N&uacute;mero de oficina:</strong></label>
        <span class="mostrarDatosInmueblesResultados"><input type="text" name="numOficina" id="numOficina" class="text-input" />
    </div>-->
    <div class="divCampo">
    ...
    <div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><input type="text" name="vlrAdmon" id="vlrAdmon" class="validate[required] text-input"<?php /*?>onkeyup="puntillos(this)" onchange="puntillos(this)"<?php */?> /></span>
    </div>
    <div class="divCampo">
  ...
  <!--<div class="divCampo">
  	...
  	<div class="divCampo">
        ...
        <span class="mostrarDatosInmueblesResultados"><input name="numPiso" type="text" class="text-input" id="numPiso" /></span>
    </div>
	<div class="divCampo">
