...
<div class="centrado">
    ...
    <div  class="columna1">
        ...
        <div class="containerpesinmue">
            ...
            <div class="contentinf video"  style="display:none">
            <div class="buscadorinmu">
...
while($registrotros= mysql_fetch_assoc($resultadootros))
				...
				$foto = "";
					...
					{
					?>
                    	 <a href="inmueble.php?cod=<?php echo $registrotros['codigo']?>" ><img src="redimencionar.php?src=/fotoinmueble/<?php echo $foto."&w=150&h=120"?>" border="0" title="Ver informacion" /></a>
                    <?php
					}
					else
					{
