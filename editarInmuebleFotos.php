...
<script type="text/javascript">
	$(document).ready(function(){
		...
		new AjaxUpload(button,{
			action: 'subir_imagenes_ajax/procesa.php?codTemp='+<?php echo $codigoTemp?>, 
			name: 'image[]',
...
<section>
  <div style="clear:left; padding-top:10px;" class="contenedor">
    	<!-- Registro -->
        <form name="registro" action="actualizarInmueble.php" method="post" enctype="multipart/form-data" id="registro">
        ...
        <input name="bario" type="hidden" value="<?php echo $_POST['barrio']?>" />
        ...
        <div class="recuadroAzul">
        	<h1 style="color:#808080" align="center">EDITAR FOTOS INMUEBLE</h1>
